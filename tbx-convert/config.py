...
wikibase_name = "TBX conversion"
wikibase_url = 'https://tbx-convert.wikibase.cloud'
entity_ns = "https://tbx-convert.wikibase.cloud/entity/"
api_url = 'https://tbx-convert.wikibase.cloud/w/api.php'
sparql_endpoint = 'https://tbx-convert.wikibase.cloud/query/sparql'
sparql_prefixes = """
PREFIX xwb: <https://tbx-convert.wikibase.cloud/entity/>
PREFIX xdp: <https://tbx-convert.wikibase.cloud/prop/direct/>
PREFIX xp: <https://tbx-convert.wikibase.cloud/prop/>
PREFIX xps: <https://tbx-convert.wikibase.cloud/prop/statement/>
PREFIX xpq: <https://tbx-convert.wikibase.cloud/prop/qualifier/>
PREFIX xpr: <https://tbx-convert.wikibase.cloud/prop/reference/>
PREFIX xno: <https://tbx-convert.wikibase.cloud/prop/novalue/>
