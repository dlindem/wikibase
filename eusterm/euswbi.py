...
wbi_config['MEDIAWIKI_API_URL'] = 'https://eusterm.wikibase.cloud/w/api.php'
wbi_config['SPARQL_ENDPOINT_URL'] = 'https://eusterm.wikibase.cloud/query/sparql'
wbi_config['WIKIBASE_URL'] = 'https://eusterm.wikibase.cloud'
