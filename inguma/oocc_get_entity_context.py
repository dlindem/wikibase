...
#
# select ?entity ?label ?aipu ?oocc_item ?oocc_pages
#
# ?ref_pages ?pdf
# where {
#   ?entity idp:P32 iwb:Q45164; rdfs:label ?label. filter(lang(?label)="eu")
...
r = requests.get("https://wikibase.inguma.eus/query/sparql?format=json&query=%23title%3A%20concepts%20part%20of%20%22OOCC%20%C3%ADndice%20de%20nombres%22%2C%20and%20their%20OOCC%20references%0APREFIX%20iwb%3A%20%3Chttps%3A%2F%2Fwikibase.inguma.eus%2Fentity%2F%3E%0APREFIX%20idp%3A%20%3Chttps%3A%2F%2Fwikibase.inguma.eus%2Fprop%2Fdirect%2F%3E%0APREFIX%20ip%3A%20%3Chttps%3A%2F%2Fwikibase.inguma.eus%2Fprop%2F%3E%0APREFIX%20ips%3A%20%3Chttps%3A%2F%2Fwikibase.inguma.eus%2Fprop%2Fstatement%2F%3E%0APREFIX%20ipq%3A%20%3Chttps%3A%2F%2Fwikibase.inguma.eus%2Fprop%2Fqualifier%2F%3E%0A%0Aselect%20%3Fentity%20%3Flabel%20%3Faipu%20%3Foocc_item%20%3Foocc_pages%20%0A%0A%3Fref_pages%20%3Fpdf%0Awhere%20%7B%0A%20%20%3Fentity%20idp%3AP32%20iwb%3AQ45164%3B%20rdfs%3Alabel%20%3Flabel.%20filter(lang(%3Flabel)%3D%22eu%22)%0A%20%20%3Fentity%20ip%3AP92%20%3Faipu.%20%3Faipu%20ips%3AP92%20%3Foocc_item%3B%20ipq%3AP80%20%3Fref_pages.%0A%20%20filter%20not%20exists%20%7B%3Faipu%20ipq%3AP93%20%3Ftext.%7D%0A%20%20%3Foocc_item%20ip%3AP71%20%5Bipq%3AP72%20%3Fpdf%5D%3B%20idp%3AP80%20%3Foocc_pages.%0A%20%7D%20")
...
for row in bindings:
    ...
    entity_name = row['label']['value']
    entity_short = re.sub(" .*", "", entity_name)
    path = f"/home/david/Zotero/storage/{row['pdf']['value']}/"
    print(f"Will try to find '{entity_short}' for '{entity_name}' in PDF at {path}")
