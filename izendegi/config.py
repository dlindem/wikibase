...
wikibase_name = "Izendegi"
wikibase_url = 'https://izendegi.wikibase.cloud'
entity_ns = "https://izendegi.wikibase.cloud/entity/"
api_url = 'https://izendegi.wikibase.cloud/w/api.php'
sparql_endpoint = 'https://izendegi.wikibase.cloud/query/sparql'
sparql_prefixes = """
PREFIX xwb: <https://izendegi.wikibase.cloud/entity/>
PREFIX xdp: <https://izendegi.wikibase.cloud/prop/direct/>
PREFIX xp: <https://izendegi.wikibase.cloud/prop/>
PREFIX xps: <https://izendegi.wikibase.cloud/prop/statement/>
PREFIX xpq: <https://izendegi.wikibase.cloud/prop/qualifier/>
PREFIX xpr: <https://izendegi.wikibase.cloud/prop/reference/>
PREFIX xno: <https://izendegi.wikibase.cloud/prop/novalue/>
