...
zotitems = pyzot.everything(pyzot.items(tag="on-wikibase"))
...
def find_lexemes_for_lang(lang):
    global lexicon
    global zotitems
    keyword_processor = KeywordProcessor()
    for binding in lexicon:
        if binding['lang']['value'] == lang:
    ...
    print(f"Fed keyword processor with {len(keyword_processor)} lemmata for language '{lang}'.")
